...
//		}
		...
		// Cagar fotos que están en disco. Nombres vienen de base de datos (listado)
	...
	buscarFotos: (id, url, ismobile) => {
		FOTOS.limpiarFotosContainer();
	...
	guardarFotoJs: function (ismobile) {
	...
	agregarFotoADisplay: function (ismobile, image) {
		...
		PRESUP.listaDeFotos.push(nombreImg);
